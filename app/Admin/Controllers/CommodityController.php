...
use App\Model\Admin\CommodityModel;
...
class CommodityController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'CommodityModel';
    ...
    {
        $grid = new Grid(new CommodityModel());
    ...
    {
        $show = new Show(CommodityModel::findOrFail($id));
    ...
    {
        $form = new Form(new CommodityModel());
